...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new MyHomePage(title: 'Reasons For Learning'),
    );
  }
}
    ...
    return new Scaffold(
      ...
      body: new Center(
        child: new Column(
          ...
          children: [
            new Text('Why should I learn:',
                style: new TextStyle(fontSize: 24.0)),
            new MyInput(),
            new Container(
                padding: new EdgeInsets.all(16.0), child: new Text('Pressure makes things like cranes and jacks work. A small amount of pressure can exert a tremendous force. Understanding pressure will be like using a lever but for liquids and gasses.',
            softWrap: true)),
            new Image.asset('images/presTube.png',fit: BoxFit.cover),
            new Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                new FlatButton(onPressed: null, child: new Text('Student')),
                new RaisedButton(onPressed: null, child: new Text('Teacher')),
                new RaisedButton(
                    onPressed: null, child: new Text('Activities')),
              ],
            ),
          ],
        ),
...
class _MyInputState extends State<MyInput> {
  ...
  void initState() {
    ...
    _currentInput = const InputValue(text: 'pressure');
  }
